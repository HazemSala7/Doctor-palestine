...
import 'package:clinic_dr_alla/Pages/optics_page/optic_details_page/optic_details_page.dart';
...
class _OpticsPageState extends State<OpticsPage> {
  ...
  Future<void> fetchPharmacies() async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse('$urlOptics$query'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyCustomAppBar(name: "مراكز بصريات"),
                      ...
                      return InkWell(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  OpticDetailsPage(opticCenter: pharmacy),
                            ),
                          );
                        },
                        child: Card(
