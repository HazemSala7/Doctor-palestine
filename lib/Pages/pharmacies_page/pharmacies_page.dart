...
import 'package:clinic_dr_alla/Pages/pharmacies_page/pharmacy_details_page/pharmacy_details_page.dart';
...
class _PharmaciesPageState extends State<PharmaciesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyCustomAppBar(name: "الصيدليات"),
