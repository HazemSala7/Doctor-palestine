...
import 'package:clinic_dr_alla/Pages/hospitals_page/hospital_details_page/hospital_details_page.dart';
...
class NutritionCentersPage extends StatefulWidget {
  @override
  _NutritionCentersPageState createState() => _NutritionCentersPageState();
}

class _NutritionCentersPageState extends State<NutritionCentersPage> {
  final ScrollController _scrollController = ScrollController();
  List<HospitalModel> _pharmacies = [];
  int _currentPage = 1;
  int _lastPage = 1;
  ...
  Future<void> fetchPharmacies() async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse('$urlNutritionCenters$query'));
      ...
      if (response.statusCode == 200) {
        ...
        final List<HospitalModel> fetched =
            data.map((e) => HospitalModel.fromJson(e)).toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyCustomAppBar(name: "مراكز تغذية"),
                      ...
                      return InkWell(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  HospitalDetailsPage(hospital: pharmacy),
                            ),
                          );
                        },
                        child: Card(
