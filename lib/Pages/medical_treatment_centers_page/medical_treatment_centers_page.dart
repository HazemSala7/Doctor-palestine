...
import 'package:clinic_dr_alla/Pages/medical_treatment_centers_page/medical_treatment_center_details_page/medical_treatment_center_details_page.dart';
...
class MedicalTreatmentCentersPage extends StatefulWidget {
  @override
  _MedicalTreatmentCentersPageState createState() =>
      _MedicalTreatmentCentersPageState();
}

class _MedicalTreatmentCentersPageState
    extends State<MedicalTreatmentCentersPage> {
  final ScrollController _scrollController = ScrollController();
  List<MedicalTreatmentCenterModel> _pharmacies = [];
  int _currentPage = 1;
  int _lastPage = 1;
  ...
  Future<void> fetchPharmacies() async {
    ...
    try {
      ...
      final response =
          await http.get(Uri.parse('$urlMedicalTreatmentCenters$query'));
      ...
      if (response.statusCode == 200) {
        ...
        final List<MedicalTreatmentCenterModel> fetched =
            data.map((e) => MedicalTreatmentCenterModel.fromJson(e)).toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyCustomAppBar(name: "مراكز العلاج الطبيعي"),
