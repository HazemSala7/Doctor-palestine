...
import 'package:clinic_dr_alla/Pages/medical_warehouses_page/medical_warehouse_details_page/medical_warehouse_details_page.dart';
...
class MedicalWarehousesPage extends StatefulWidget {
  @override
  _MedicalWarehousesPageState createState() => _MedicalWarehousesPageState();
}

class _MedicalWarehousesPageState extends State<MedicalWarehousesPage> {
  final ScrollController _scrollController = ScrollController();
  List<MedicalWarehouseModel> _pharmacies = [];
  int _currentPage = 1;
  int _lastPage = 1;
  ...
  Future<void> fetchPharmacies() async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse('$urlMedicalWarehouses$query'));
      ...
      if (response.statusCode == 200) {
        ...
        final List<MedicalWarehouseModel> fetched =
            data.map((e) => MedicalWarehouseModel.fromJson(e)).toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyCustomAppBar(name: "مستودعات طبية"),
